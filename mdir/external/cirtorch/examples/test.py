...
whitening_names = ['retrieval-SfM-30k', 'retrieval-SfM-120k', 'load:retrieval-SfM-30k', 'load:retrieval-SfM-120k']
...
def main():
    ...
    if args.whitening is not None:
        ...
        if args.whitening.startswith("load"):
            assert 'Lw' in net.meta and args.whitening.split(":", 1)[1] in net.meta['Lw']

            print('>> {}: Whitening is precomputed, loading it...'.format(args.whitening.split(":", 1)[1]))

            if len(ms)>1:
                Lw = net.meta['Lw'][args.whitening.split(":", 1)[1]]['ms']
            else:
                Lw = net.meta['Lw'][args.whitening.split(":", 1)[1]]['ss']
